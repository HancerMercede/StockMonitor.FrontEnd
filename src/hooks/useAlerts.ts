...
const mockAlerts: Alert[] = [
  {
    ...
    symbol: 'SPY',
    type: 'MACD_Bearish',
    message: '🔴 SPY: Down 4.5% to $653 - MACD Bearish Crossover confirmed',
    priority: 'High',
    ...
    mlQualityRating: 'A',
    mlRecommendation: 'AVOID',
    mlReasons: [
      '✅ Setup bajista tiene historial de 78% win-rate',
      '✅ MACD Bearish + BB Break precisión del 82% en detectar continuación',
      '✅ Volumen de distribución elevado confirma convicción institucional',
      '✅ Correlación multi-activo (SPY, Nasdaq, BTC) aumenta confiabilidad',
      '⚠️ Evitar compras - Posible rebote técnico solo si RSI cae bajo 25'
    ],
    indicators: {
      currentPrice: 653.00,
      rsi: 38.2,
      macd: { macd: -3.85, signal: -1.20, histogram: -2.65, trend: 'Bearish' },
      bollingerBands: { upperBand: 688.50, middleBand: 670.20, lowerBand: 651.90, position: 'Middle-Lower' },
      trend: { adx: 52.8, trendStrength: 'Extremely Strong', trendDirection: 'Down' },
      volume: { relativeVolume: 2.45, volumeSignal: 'Panic Selling' },
      movingAverages: { sma20: 673.80, sma50: 678.40, overallTrend: 'Death Cross Forming' }
    }
  },
  {
    id: '2',
    symbol: 'SPY',
    type: 'RSI_Bearish',
    message: '⚠️ SPY: RSI at 38.2 declining - Bearish momentum building',
    priority: 'High',
  ...
  },
  {
    ...
    symbol: 'SPY',
    type: 'Trend_Weak',
    message: '📉 SPY: Breaking support levels - Trend reversal confirmed',
    priority: 'High',
  ...
  },
  {
    ...
    message: '💪 SPY: Strong bearish momentum - Sellers in full control',
    priority: 'High',
  ...
  },
  {
    ...
    message: '📊 SPY: Multiple resistance levels above - Upside capped',
    priority: 'High',
  ...
  // QQQ - Señal de VENTA FUERTE (Tech Selloff)
  {
    id: '6',
    symbol: 'QQQ',
    type: 'MACD_Bearish',
    message: '🔴 QQQ: Nasdaq crashes 4.5% to $589.50 - Tech bloodbath',
    priority: 'High',
    ...
    indicators: {
      currentPrice: 589.50,
      rsi: 35.5,
      macd: { macd: -4.85, signal: -1.95, histogram: -2.90, trend: 'Bearish' },
      bollingerBands: { upperBand: 622.30, middleBand: 605.80, lowerBand: 589.30, position: 'Middle-Lower' },
      trend: { adx: 55.3, trendStrength: 'Extremely Strong', trendDirection: 'Down' },
      volume: { relativeVolume: 2.85, volumeSignal: 'Extreme Panic' },
      movingAverages: { sma20: 608.90, sma50: 614.20, overallTrend: 'Death Cross Imminent' }
    }
  },
  {
    id: '7',
    symbol: 'QQQ',
    type: 'RSI_Bearish',
    message: '📉 QQQ: RSI 35.5 showing weakness - More downside expected',
    priority: 'High',
  ...
  },
  {
    ...
    symbol: 'QQQ',
    type: 'Momentum_Bearish',
    message: '⚠️ QQQ: Bearish momentum accelerating - Tech sector under pressure',
    priority: 'High',
