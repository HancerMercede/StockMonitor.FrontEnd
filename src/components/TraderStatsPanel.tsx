      ...
      <div className="bg-white rounded-xl p-6 border-2 border-slate-200">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <span className="text-sm text-slate-500">{pagination.totalCount} trades registrados</span>
          </div>
          <div className="flex items-center space-x-3">
            {/* Items por página */}
            <div className="flex items-center space-x-2 bg-slate-50 px-3 py-2 rounded-lg border border-slate-200">
              ...
              <select
                ...
                className="px-2 py-1 border border-slate-300 rounded-md text-sm font-semibold text-slate-900 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 cursor-pointer"
              >
        ...
        {/* Paginación Elegante */}
        {trades.length > 0 && pagination.totalPages > 1 && (
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-200">
            {/* Info compacta */}
            <span className="text-sm text-slate-500">
              Página <span className="font-semibold text-slate-900">{pagination.currentPage}</span> de <span className="font-semibold text-slate-900">{pagination.totalPages}</span>
            </span>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="p-2 rounded-lg border border-slate-300 hover:bg-blue-50 hover:border-blue-400 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
